...
def parse_args():
    ...
    parser.add_argument('--dataset_type', type=str, default='aime2024',
                        choices=['gsm8k', 'aime2024', 'aime2024short', 'aime2025', 'math', 'math500', 'mmlu_pro', 'gpqa_diamond', 'answerbench', 'medrect', 'auto'],
                        help='Dataset type (default: aime2024). Choices: gsm8k, aime2024, aime2024short, aime2025, math, math500, mmlu_pro, gpqa_diamond, answerbench, medrect, auto')
...
def main():
    ...
    if args.dataset_type == 'medrect' and args.test_file == '/workspace/AIME_2024/aime_2024_problems.parquet':
        args.test_file = '/workspace/medrect/data/medrect/medrect-ja-step4-accepted.json'
